...
class DatabaseHelperImpl(private val appDatabase: AppDatabase) : DatabaseHelper {
    ...
    override fun getByIdProvider(id: Int?): Cursor =
        appDatabase.userFavoriteDao().getByIdProvider(id)

    override fun insertProvider(user: UserFavorite?): Long =
        appDatabase.userFavoriteDao().insertProvider(user)
    ...
    override suspend fun insert(user: UserFavorite?): Long =
        appDatabase.userFavoriteDao().insert(user)
